...
impl GeminiCliProvider {
    /// Testable variant that takes the settings.json path explicitly instead
    /// of resolving it via `dirs::home_dir()`. Production callers should use
    /// the trait method `ensure_configured` which delegates here.
